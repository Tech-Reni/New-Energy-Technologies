...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.body.insertAdjacentHTML('beforeend', '<a class="whatsapp-float" href="https://wa.me/" target="_blank" rel="noopener" aria-label="Chat with Nature Energy Technologies on WhatsApp" title="Chat with us on WhatsApp"><i class="ri-whatsapp-line"></i></a>');
